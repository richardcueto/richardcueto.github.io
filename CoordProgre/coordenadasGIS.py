...
# Ignorar la advertencia especÃ­fica
warnings.filterwarnings("ignore", category=FutureWarning)

def extraer_decenas(cadena):
  # Convertir la cadena a entero y luego a cadena nuevamente para eliminar cualquier caracter no numÃ©rico
  cadena_numerica = ''.join(filter(str.isdigit, cadena))
  
  # Verificar si la cadena numÃ©rica tiene al menos dos caracteres
...
def convertir_a_utm(latitud, longitud):
  # Definir el sistema de coordenadas de origen (geogrÃ¡ficas)
...
# Llama a la funciÃ³n para extraer coordenadas
utm_zone = 18  # por ejemplo, UTM Zone 10 en NorteamÃ©rica
utm_band = 'S'

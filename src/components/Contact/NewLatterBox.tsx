  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold leading-tight text-black dark:text-white">
        suscribete para recibir nuevas publicaciones
      </h3>
      ...
      <div>
        {/* SVG 1 */}
        <span className="absolute top-7 left-2 text-primary dark:text-white">
          <svg
            width="57"
            height="65"
            viewBox="0 0 57 65"
        ...
        {/* SVG 2 */}
        <span className="absolute bottom-24 left-1.5 text-primary dark:text-white">
          <svg
            width="39"
            height="32"
            viewBox="0 0 39 32"
        ...
        {/* SVG 3 */}
        <span className="absolute top-[140px] right-2 text-primary dark:text-white">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
        ...
        {/* SVG 4 */}
        <span className="absolute top-0 right-0 text-primary dark:text-white">
          <svg
            width="162"
            height="91"
            viewBox="0 0 162 91"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop offset="0.328125" stopColor="currentColor" />
                <stop offset="1" stopColor="currentColor" stopOpacity="0" />
              </linearGradient>
              <linearGradient
